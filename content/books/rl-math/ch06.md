...
式(6.1)就是蒙特卡罗估计的基本思想，并且大数定律告诉我们，当 $n\to\infty$ 时， $\bar{x}\to E[X]$ 。这些已经在第5章介绍过了。
...
值得提醒大家的是，本节有较多的数学内容。如果大家对随机近似算法的收敛分析感兴趣，推荐阅读本节；否则可以跳过这一节，并不会影响后续章节的学习。定理6.2 (Dvoretzky 定理)。考虑如下的随机过程：
...
![](images/7e8b866caa7e90966b0674ff03ede234cbcc2bcb8d9ced568c60e0456b473c71.jpg)
