...
$$
\begin{array}{r l} \mathbb{E} \left[ \left(r_{t + 1} + \gamma \phi^{\mathrm{T}} (s_{t + 1}) w_{t} - \phi^{\mathrm{T}} (s_{t}) w_{t}\right) \phi (s_{t}) \right] & = \Phi^{\mathrm{T}} D r_{\pi} - \Phi^{\mathrm{T}} D (I - \gamma P_{\pi}) \Phi w_{t} \\ & \doteq b - A w_{t}, \end{array} \tag{8.27}
$$
