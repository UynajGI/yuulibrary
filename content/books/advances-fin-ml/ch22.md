...
## 22.7 总结与参与呼吁
目前，构建大规模计算平台有两种主要方式：HPC 方法和云方法。 Most of
the scientific computing efforts use the HPC approach, while most of the
business computing needs are satisfied through the cloud approach. 传统观点认为 HPC 方法占据一个不太重要的小众市场。 This is not true. HPC 系统对科学研究的进展至关重要。 They played important roles in exciting
...
commerce through the Internet. 超大规模 HPC 系统的有用性促成了 2015 年国家战略计算倡议。^\ [[3]^
