...
favorable risk-adjusted return. 结构性突变, like the transition
...
-   **爆炸性检验:** Beyond deviation from white noise, these
...
## 17.4 爆炸性检验
爆炸性检验 can be generally divided between those that test
...
2.4.1), as well as the SADF derived from that price series. SADF
