...
拟合决策树时，特征空间沿与轴对齐的方向旋转通常会减少树所需的层数。因此，我建议在特征的 PCA 上拟合 RF，因为这可能加速计算并减少一些过拟合（详见[第 8 章](ch08.md)）。此外，如第 4 章第 4.8 节讨论，`class_weight='balanced_subsample'` 将帮助你防止树误分类少数类。
