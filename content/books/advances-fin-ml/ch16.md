...
## 16.1 动机
This chapter introduces the Hierarchical Risk Parity (HRP)
approach.^\ [[1]^
...
## 16.2 凸投资组合优化的问题
Portfolio construction is perhaps the most recurrent financial problem.
On a daily basis, investment managers must build portfolios that
incorporate their views and forecasts on risks and returns. This is the
...
This concludes a first description of the HRP algorithm, which solves
